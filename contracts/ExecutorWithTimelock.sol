...
contract ExecutorWithTimelock is IExecutorWithTimelock {
  ...
  function getQuorum() external pure override returns (uint256) {
    return 300; // TODO replace, now 3%
  }

  function getForVotesNeededForQuorum() external pure override returns (uint256) {
    return 0; // TODO
  }

  function getVotesDifferential() external pure override returns (uint256) {
    return 0; // TODO
  }
